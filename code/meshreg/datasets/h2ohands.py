...
import sys
sys.path.append('../../')
from meshreg.datasets import h2outils
from meshreg.datasets.queries import BaseQueries,TransQueries, get_trans_queries
...
class H2OHands(object):
    def __init__(
        ...
        frame_segments,action_to_idx,object_to_idx=h2outils.load_split_video_segments_list(self.root)
